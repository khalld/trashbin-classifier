...
def train_model_adapted(model, dst_container, criterion, optimizer, num_epochs=25, is_inception=False):
    # to add in parameter of function
            ...
            for inputs, labels in dataloaders[phase]:
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    ...
                    if is_inception and phase == 'train':
                        ...
                        print("SONO NELL'ELSE E LA PHASE e'...", phase)
